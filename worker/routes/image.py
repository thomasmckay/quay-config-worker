...
def process(resources):
    ...
    for resource in resources:
        ...
        if p_state == "absent":
            return {"failed": True, "msg": "TODO: Image 'absent' not implemented"}, 400
        else:  # present
            if image is None:
                changed = True
                username = None
                ...
                parent = None
                image = model.image.set_image_metadata(
                    image_id,
                    p_project,
                    p_repository,
                    created,
